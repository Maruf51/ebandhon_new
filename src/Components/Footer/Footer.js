            ...
            <div className="container">
                <div className="footer_details">
                    ...
                    <div className="footer_contact footer_options">
                        ...
                        <p>eBandhon</p>
                        <p>1000 DHAKA,</p>
                        <a href="tel:01723892832"><FontAwesomeIcon className="footer_contact_icon" icon={faPhoneAlt}/>+880 1723-892832</a>
                    ...
                    <div className="footer_get_in_touch footer_options">
                        ...
                        <div className="footer_social_icons">
                            ...
                            <a target="_blank" id="footer_icon" href="https://www.facebook.com/ebandhon2023"><FontAwesomeIcon icon={faFacebookSquare} /></a>
