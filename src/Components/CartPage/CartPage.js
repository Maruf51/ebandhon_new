        ...
        if(total > '500000'){
            ...
            // else {
                ...
                if(cartInfo.cartProducts && cartInfo.cartProducts.length !== 0) {
                    ...
                    newData.imageProfile = loginData.image
                    ...
                    fetch(`https://ebandhonnewserver-production-89c9.up.railway.app/buy-products/id?id=${newData.uid}`, {
                        method:'PATCH',
                    ...
                    .then(result => {
                        ...
                        if(result.success === true) {
                            window.location.replace('https://ebandhon.com/payment/success')
                        }
                    })
