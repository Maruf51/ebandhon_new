...
const LuckyWinnerForm = () => {
    ...
    useEffect(() => {
        fetch('https://ebandhonnewserver-production-89c9.up.railway.app/get-lucky-winner-data')
        .then(res => res.json())
            ...
            if(data.phoneNumber.length === 11 || data.phoneNumber.length === 13) {
                ...
                if(alreadySubmittedEmail === undefined) {
                    ...
                    if(alreadySubmittedNumber === undefined) {
                        setError('')
                        fetch('https://ebandhonnewserver-production-89c9.up.railway.app/add-lucky-winner-data', {
                            method:'POST',
