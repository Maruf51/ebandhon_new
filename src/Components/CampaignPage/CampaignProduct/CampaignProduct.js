...
const CampaignProduct = (props) => {
    ...
    const onSubmit = data => {
        ...
        //     else {
                ...
                const payment_data = {amount:(quantity * parseInt(props.CPrice)), transaction_id:transactionId, success_url:'https://ebandhon.com/payment/success', fail_url:'https://ebandhon.com/payment/fail', customer_name:newData.fullName, customer_mobile:newData.number}
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div id="CP_shipment" className="cart_shipment">
                        ...
                        <div id="CP_shipment_field" className="shipment_field">
                            ...
                            <input defaultValue={cartFormDetails.mainAddress} {...register("mainAddress", { required: true })} id="mainAddress" type="text" placeholder="Main Address (Optional)"/>
                        </div>
                        <div id="CP_shipment_field" className="shipment_field">
                        ...
                        <div className="CP_shipment_price_total">
                            ...
                            <div className="CP_shipment_price_total_child">
                                <span>Total</span>
                                <span>৳ {(quantity * parseInt(props.CPrice))}</span>
                            </div>
                        </div>
