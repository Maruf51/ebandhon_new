...
const CampaignPageUpload = () => {
    ...
    useEffect(() => {
        fetch('https://ebandhonnewserver-production-89c9.up.railway.app/get-campaign-data')
    ...
    const uploadCampaignProduct = (e) => {
        ...
        if(selectedCat.products) {
            fetch(`https://ebandhonnewserver-production-89c9.up.railway.app/add-campaign-product/id?id=${selectedCat._id}`, {
                method:'PATCH',
